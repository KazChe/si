...
sudo mkdir -p /usr/local/postgresql-9.4.1/data
...
cd $DIR
echo "+++++++++ " $PWD
sudo su -c ./sf_pentaho-oem-installer/1_install_database/centos/postgres_config_files/createPGinit.sh postgres
